...
class SecurityConfiguration(
    ...
    override fun configure(http: HttpSecurity?) {
        ...
        http?.addFilterBefore(JWTAuthenticationFiler(jwtUtil = jwtUtil), UsernamePasswordAuthenticationFilter().javaClass)
    ...
    override fun configure(auth: AuthenticationManagerBuilder?) {
        auth?.userDetailsService(userDetailService)?.passwordEncoder(bCriptPasswordEncoder())
    }
